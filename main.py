...
def get_current_watchlist():
    ...
    return [ "Star Wars", "Minions", "Freaky Friday", "My Favorite Martian", "The Matrix" ]
...
def crossoff_movie():
    ...
    return render_template("crossoff.html", crossed_off=crossed_off_movie)
...
def add_movie():
    ...
    return render_template("index.html", movie=new_movie, error=error_arg)
